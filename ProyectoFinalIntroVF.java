...
public class ProyectoFinalIntroVF {
  public static void main(String[] args) throws IOException {
    ...
    if (y.equalsIgnoreCase("si")) {
      ...
      parcial1 = Double.parseDouble(JOptionPane.showInputDialog(null, "Cuánto vale el Primer Examen Parcial?", "Porcentaje: Primer Parcial", JOptionPane.QUESTION_MESSAGE));
      parcial2 = Double.parseDouble(JOptionPane.showInputDialog(null, "Cuánto vale el Segundo Examen Parcial?", "Porcentaje: Segundo Parcial", JOptionPane.QUESTION_MESSAGE));
